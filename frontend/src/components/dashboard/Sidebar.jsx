...
export const Sidebar = ({ activeTab, setActiveTab, isMobileMenuOpen, setIsMobileMenuOpen, setShowInviteModal }) => (
  <aside className={`fixed inset-y-0 left-0 z-40 w-64 bg-[#FAFAFA] border-r border-slate-200 transform transition-transform duration-300 ease-in-out flex flex-col ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
    ...
    <div className="p-6 border-b border-slate-200">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="text-sm font-semibold text-slate-900 truncate">Jane Doe</h2>
    ...
    <div className="p-4 border-t border-slate-200 space-y-2">
      ...
      <Button variant="ghost" className="w-full justify-start text-slate-600 hover:text-red-600" icon={LogOut}>
        Log out
      </Button>
    </div>
  </aside>
